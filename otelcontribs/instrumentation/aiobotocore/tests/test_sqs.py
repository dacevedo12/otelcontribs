...
class TestSqsExtension(TestBase):
    ...
    @mock_sqs
    def test_sqs_messaging_send_message(self) -> None:
    ...
    @mock_sqs
    def test_sqs_messaging_send_message_batch(self) -> None:
        create_queue_result = async_call(
            self.client.create_queue(QueueName="test_queue_name")
        )
        queue_url = create_queue_result["QueueUrl"]
    ...
    @mock_sqs
    def test_sqs_messaging_receive_message(self) -> None:
        create_queue_result = async_call(
            self.client.create_queue(QueueName="test_queue_name")
        )
        queue_url = create_queue_result["QueueUrl"]
    ...
    @mock_sqs
    def test_sqs_messaging_failed_operation(self) -> None:
